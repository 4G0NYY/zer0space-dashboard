...
const STRINGS = {
  de: {
    ...
    'home.backup': 'Backup',
    'home.nodes': 'Nodes',
    'home.standaloneHosts': 'Standalone-Hosts',
    'home.infra': 'Infrastruktur',
    'home.unreachable': 'Nicht erreichbar',
    ...
    // ── Login ─────────────────────────────────────────────────────────────
    // ── Setup wizard / registration / password strength ───────────────────
    'setup.title': 'Willkommen bei zer0space',
    'setup.subtitle': 'Ersten Administrator anlegen',
    'setup.usernameHint': '3–32 Zeichen: Buchstaben, Ziffern, Punkt, Unterstrich, Bindestrich.',
    ...
    'setup.done': 'Fertig — du wirst zur Anmeldung weitergeleitet …',
    'setup.note': 'Diese Seite ist nur erreichbar, solange kein Konto existiert. Danach wird sie dauerhaft geschlossen.',

    'register.title': 'Konto erstellen',
    'register.subtitle': 'Mit Einladungscode',
    'register.code': 'Einladungscode',
    'register.submit': 'Konto erstellen',
    'register.done': 'Konto erstellt — du wirst zur Anmeldung weitergeleitet …',

    'pw.minLength': 'Passwort muss mindestens {n} Zeichen haben',
    'pw.tooShort': 'Zu kurz',
    'pw.weak': 'Schwach',
    'pw.fair': 'Mittel',
    'pw.good': 'Gut',
    ...
    // ── Invitations (admin settings) ──────────────────────────────────────
    'invites.title': 'Einladungen',
    'invites.description': 'Neue Konten entstehen ausschliesslich über einen Einladungscode. Jeder Code gilt einmal.',
    'invites.create': 'Code erstellen',
    'invites.validity': 'Gültigkeit',
    'invites.days': 'Tage',
    'invites.role': 'Rolle',
    'invites.roleViewer': 'Betrachter',
    'invites.roleAdmin': 'Administrator',
    'invites.none': 'Noch keine Einladungen',
    'invites.status.active': 'Aktiv',
    'invites.status.used': 'Eingelöst',
    'invites.status.expired': 'Abgelaufen',
    'invites.expires': 'Läuft ab',
    'invites.usedBy': 'Eingelöst von {name}',
    'invites.copy': 'Link kopieren',
    'invites.copied': 'Kopiert',
    'invites.revoke': 'Widerrufen',
    'invites.revokeConfirm': 'Diesen Einladungscode widerrufen?',
    'invites.created': 'Einladung erstellt — Link kopieren und weitergeben.',
    ...
    'login.haveInvite': 'Einladungscode einlösen',
    'login.registered': 'Konto erstellt — du kannst dich jetzt anmelden.',
    ...
    'err.PW_TOO_LONG': 'Passwort ist zu lang (max. 72 Bytes)',
    'err.PW_MISSING': 'Passwort fehlt',
    'err.USERNAME_MISSING': 'Benutzername fehlt',
    'err.USERNAME_INVALID': 'Benutzername: 3–32 Zeichen (Buchstaben, Ziffern, . _ -)',
    'err.RATE_LIMITED': 'Zu viele Versuche. Bitte später erneut versuchen.',
    'err.RATE_LIMITED_MIN': 'Zu viele Versuche. Bitte {n} Minute(n) warten.',
    'err.ACCOUNT_LOCKED': 'Konto vorübergehend gesperrt',
    'err.ACCOUNT_LOCKED_MIN': 'Konto nach zu vielen Fehlversuchen gesperrt. Entsperrt sich in {n} Minute(n).',
    'err.CSRF_INVALID': 'Ungültiges oder fehlendes CSRF-Token',
    'err.SETUP_CLOSED': 'Die Einrichtung ist bereits abgeschlossen',
    'err.INVITE_INVALID': 'Einladungscode ungültig oder abgelaufen',
    'err.INVITE_NOT_FOUND': 'Einladung nicht gefunden oder bereits eingelöst',
    'err.INVITE_EXPIRY_INVALID': 'Gültigkeit muss zwischen 1 und 90 Tagen liegen',
    'err.INVITE_QUOTA': 'Einladungs-Limit erreicht — bitte später erneut versuchen',
    'err.SETTING_UNKNOWN': 'Unbekannte Einstellung',
    'err.SETTING_TOO_LONG': 'Wert zu lang',
    'err.THEME_INVALID': 'Ungültiges Theme',
  ...
  en: {
    ...
    'users.pwMin12': 'Password min. 12 characters',
    'users.you': '(you)',
    ...
    // ── Login ─────────────────────────────────────────────────────────────
    // ── Setup wizard / registration / password strength ───────────────────
    'setup.title': 'Welcome to zer0space',
    'setup.subtitle': 'Create the first administrator',
    'setup.usernameHint': '3-32 characters: letters, digits, dot, underscore, hyphen.',
    'setup.confirm': 'Confirm password',
    'setup.submit': 'Create administrator',
    'setup.mismatch': 'The passwords do not match',
    'setup.failed': 'Setup failed',
    'setup.done': 'Done — taking you to the sign-in page …',
    'setup.note': 'This page is reachable only while no account exists. It closes permanently afterwards.',

    'register.title': 'Create account',
    'register.subtitle': 'With an invitation code',
    'register.code': 'Invitation code',
    'register.submit': 'Create account',
    'register.done': 'Account created — taking you to the sign-in page …',

    'pw.minLength': 'Password must be at least {n} characters',
    ...
    'invites.description': 'New accounts can only be created through an invitation code. Each code works once.',
    'invites.create': 'Create code',
    'invites.validity': 'Valid for',
    'invites.days': 'days',
    'invites.role': 'Role',
    'invites.roleViewer': 'Viewer',
    'invites.roleAdmin': 'Administrator',
    'invites.none': 'No invitations yet',
    'invites.status.active': 'Active',
    'invites.status.used': 'Redeemed',
    'invites.status.expired': 'Expired',
    'invites.expires': 'Expires',
    'invites.usedBy': 'Redeemed by {name}',
    'invites.copy': 'Copy link',
    'invites.copied': 'Copied',
    'invites.revoke': 'Revoke',
    'invites.revokeConfirm': 'Revoke this invitation code?',
    'invites.created': 'Invitation created — copy the link and share it.',
    ...
    'login.haveInvite': 'Redeem an invitation code',
    ...
    'err.PW_TOO_LONG': 'Password is too long (max 72 bytes)',
    'err.PW_MISSING': 'Password missing',
    'err.USERNAME_MISSING': 'Username missing',
    'err.USERNAME_INVALID': 'Username: 3-32 characters (letters, digits, . _ -)',
    'err.RATE_LIMITED': 'Too many attempts. Please try again later.',
    'err.RATE_LIMITED_MIN': 'Too many attempts. Please wait {n} minute(s).',
    'err.ACCOUNT_LOCKED': 'Account temporarily locked',
    'err.ACCOUNT_LOCKED_MIN': 'Account locked after repeated failed logins. Unlocks in {n} minute(s).',
    'err.CSRF_INVALID': 'CSRF token invalid or missing',
    'err.SETUP_CLOSED': 'Setup is already complete',
    'err.INVITE_INVALID': 'Invitation code invalid or expired',
    'err.INVITE_NOT_FOUND': 'Invite not found or already redeemed',
    'err.INVITE_EXPIRY_INVALID': 'Expiry must be between 1 and 90 days',
    'err.INVITE_QUOTA': 'Invite limit reached — please try again later',
    'err.SETTING_UNKNOWN': 'Unknown setting',
    'err.SETTING_TOO_LONG': 'Value too long',
    'err.THEME_INVALID': 'Invalid theme',
